...
namespace Pacman
{
    ...
    public class LevelCreation
    {
        ...
        public LevelCreation()
        {
            ...
            consoleRenderer = new ConsoleRenderer(84, 31, backgroundPixel,
                                                    "Console Renderer");
            scene = new Scene(28, 31);

            collisions = new Collision(scene, consoleRenderer);

            map = new MapComponent(28, 31);
